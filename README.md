...
Biblioteca de ideias de **lettering fáceis de fazer à mão** para deixar cadernos de estudo bonitos e organizados — inspirada na estética de resumos aesthetic do Pinterest.

**✨ Acesse online:** https://lanabiatriz2001-ai.github.io/caderno-juridico/

São **411 ideias** organizadas em 12 categorias.

## O que tem

- **Títulos** — banners de fita, marca-texto atravessado, letra adesivo, cartão com fita, cabeçalho completo…
- **Subtítulos** — pinceladas, cantoneiras, correntes, fitas quadriculadas, ondinhas…
- **Tópicos** — números em círculos, quadradinhos com sombra, etiquetas recortadas…
- **Subtópicos** — marcadores variados (bolinhas, corações, estrelinhas, setinhas…)
...
- 🎨 Troque a cor da biblioteca inteira (lavanda, rosa, céu, menta, amarelo, pêssego)
- ♡ Salve seus modelos favoritos (ficam guardados no dispositivo)
- 🔍 Busque em toda a biblioteca

## Tecnologia

Arquivo único (`index.html`) em HTML, CSS e JavaScript puro — sem build, sem frameworks. Favoritos em `localStorage`. Fontes via Google Fonts.
